...
pubDatetime: 2024-08-15T18:34:35.000Z
author: caorushizi
tags:
  - 工程化
postSlug: acf22a0a-87de-4627-a564-cdcd04a504bb
description: >-
  在 Webpack 中，externals 是一个配置选项，用于指定哪些模块不应该被打包到最终的 bundle
  中。这个选项的主要作用是避免将某些依赖项包括在打包文件中，而是将这些依赖项作为外部资源进行加载。以下是 externals 的详细作用和使用场景： 1.
  避免重复打包 如果你的项目依赖某些库，而这些库在运行时会从 CDN 或其他外部来源加载（比如 jQuery、React），你可以使用
difficulty: 1
questionNumber: 2611
source: https://fe.ecool.fun/topic/acf22a0a-87de-4627-a564-cdcd04a504bb
---
