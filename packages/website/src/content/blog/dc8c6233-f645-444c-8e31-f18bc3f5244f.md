...
pubDatetime: 2024-08-10T19:48:26.000Z
author: caorushizi
tags:
  - CSS
postSlug: dc8c6233-f645-444c-8e31-f18bc3f5244f
description: >-
  一、是什么 响应式网站设计（Responsive Web
  design）是一种网络页面设计布局，页面的设计与开发应当根据用户行为以及设备环境(系统平台、屏幕尺寸、屏幕定向等)进行相应的响应和调整
  描述响应式界面最著名的一句话就是“Content is like water” 大白话便是“如果将屏幕看作容器，那么内容就像水一样” 响应式网站常见特点：
  同时适配PC + 平板 + 手机等 标签导航在接
difficulty: 3
questionNumber: 174
source: https://fe.ecool.fun/topic/dc8c6233-f645-444c-8e31-f18bc3f5244f
---
