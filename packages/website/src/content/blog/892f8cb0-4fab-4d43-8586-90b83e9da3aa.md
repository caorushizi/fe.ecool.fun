...
pubDatetime: 2024-08-15T09:12:41.000Z
author: caorushizi
tags:
  - 工程化
postSlug: 892f8cb0-4fab-4d43-8586-90b83e9da3aa
description: >-
  Webpack 的 tree-shaking 是一种优化技术，用于去除未使用的代码，从而减小最终打包文件的大小。尽管 tree-shaking
  是一个强大的工具，但在一些情况下，它可能会失效。以下是导致 Webpack tree-shaking 失效的一些常见情况： 1. 未使用 ES6 模块语法
  问题：Webpack 的 tree-shaking 依赖于 ES6 模块语法（import 和 ex
difficulty: 3
questionNumber: 2657
source: https://fe.ecool.fun/topic/892f8cb0-4fab-4d43-8586-90b83e9da3aa
---
