...
pubDatetime: 2024-01-24T17:27:02.000Z
author: caorushizi
tags:
  - CSS
postSlug: fad85622-728a-4c93-bf22-d91f8902837d
description: >-
  一、是什么 视差滚动（Parallax Scrolling）是指多层背景以不同的速度移动，形成立体的运动效果，带来非常出色的视觉体验
  我们可以把网页解刨成：背景层、内容层、悬浮层 当滚动鼠标滑轮的时候，各个图层以不同的速度移动，形成视觉差的效果 二、实现方式
  使用css形式实现视觉差滚动效果的方式有： background-attachment transform:translate3D back
difficulty: 2.5
questionNumber: 171
source: https://fe.ecool.fun/topic/fad85622-728a-4c93-bf22-d91f8902837d
---
