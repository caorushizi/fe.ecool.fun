...
pubDatetime: 2021-10-24T20:58:46.000Z
author: caorushizi
tags:
  - React.js
postSlug: bc832a32-bf3a-4ee0-b980-89332d68596c
description: >-
  一、是什么 在日常开发中，页面切换时的转场动画是比较基础的一个场景 当一个组件在显示与消失过程中存在过渡动画，可以很好的增加用户的体验
  在react中实现过渡动画效果会有很多种选择，如react-transition-group，react-motion，Animated，以及原生的CSS都能完成切换动画
  二、如何实现 在react中，react-transition-group是一种很好的解决方
difficulty: 2
questionNumber: 657
source: https://fe.ecool.fun/topic/bc832a32-bf3a-4ee0-b980-89332d68596c
---
