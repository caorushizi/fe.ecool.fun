---
title: 说说vue中的diff算法
pubDatetime: 2024-08-10T17:04:45.000Z
author: caorushizi
tags:
  - Vue.js
postSlug: 7d27dc57-5d95-4e3f-88a7-eb685b7c21e4
description: >-
  一、是什么 diff 算法是一种通过同层的树节点进行比较的高效算法 其有两个特点： 比较只会在同层级进行, 不会跨层级比较
  在diff比较的过程中，循环从两边向中间比较 diff 算法的在很多场景下都有应用，在 vue 中，作用于虚拟 dom 渲染成真实 dom 的新旧
  VNode 节点比较 二、比较方式 diff整体策略为：深度优先，同层比较 比较只会在同层级进行, 不会跨层级比较 比较的过程中
difficulty: 3
questionNumber: 244
source: https://fe.ecool.fun/topic/7d27dc57-5d95-4e3f-88a7-eb685b7c21e4
---
