...
tags:
  - Vue.js
postSlug: da1881cc-64b9-40f8-8a25-a6256c1349ed
description: >-
  一、什么是双向绑定
  ...
  当用户填写表单时，View的状态就被更新了，如果此时可以自动更新Model的状态，那就相当于我们把Model和V
difficulty: 2
questionNumber: 224
source: https://fe.ecool.fun/topic/da1881cc-64b9-40f8-8a25-a6256c1349ed
---
