...
pubDatetime: 2024-09-04T01:19:05.000Z
author: caorushizi
tags:
  - React.js
postSlug: 467f7aeb-e452-421e-9404-da26f158adee
description: >-
  在 React 中，Hooks 和 MemorizedState 都与组件的状态管理和性能优化有关，但它们的作用和实现方式不同。 Hooks Hooks 是
  React 16.8 引入的一组 API，使函数组件能够拥有状态和副作用管理的能力，之前这些特性只有在类组件中才可以使用。常用的 Hooks 包括：
  useState：用于在函数组件中添加状态。 useEffect：用于处理副作用，如数据获取
difficulty: 3
questionNumber: 2406
source: https://fe.ecool.fun/topic/467f7aeb-e452-421e-9404-da26f158adee
---
