...
pubDatetime: 2024-08-10T17:05:31.000Z
author: caorushizi
tags:
  - Node.js
postSlug: f866a768-1751-49cc-aff2-133021222b20
description: >-
  一、模块规范 NodeJS对CommonJS进行了支持和实现，让我们在开发node的过程中可以方便的进行模块化开发：
  在Node中每一个js文件都是一个单独的模块 模块中包括CommonJS规范的核心变量：exports、module.exports、require
  通过上述变量进行模块化开发 而模块化的核心是导出与导入，在Node中通过exports与module.exports负责对模块中的内
difficulty: 3
questionNumber: 552
source: https://fe.ecool.fun/topic/f866a768-1751-49cc-aff2-133021222b20
---
