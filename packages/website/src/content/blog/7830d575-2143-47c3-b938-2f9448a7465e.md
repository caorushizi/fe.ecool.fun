...
pubDatetime: 2021-07-04T21:31:03.000Z
author: caorushizi
tags:
  - React.js
postSlug: 7830d575-2143-47c3-b938-2f9448a7465e
description: >-
  Fiber 出现的背景 首先要知道的是，JavaScript 引擎和页面渲染引擎两个线程是互斥的，当其中一个线程执行时，另一个线程只能挂起等待。
  在这样的机制下，如果 JavaScript
  线程长时间地占用了主线程，那么渲染层面的更新就不得不长时间地等待，界面长时间不更新，会导致页面响应度变差，用户可能会感觉到卡顿。 而这正是 React 15
  的 Stack Reconciler 所面临的问题，
difficulty: 4
questionNumber: 313
source: https://fe.ecool.fun/topic/7830d575-2143-47c3-b938-2f9448a7465e
---
