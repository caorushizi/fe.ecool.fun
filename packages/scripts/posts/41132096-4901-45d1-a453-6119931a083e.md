...
pubDatetime: 2024-01-25T14:32:34.000Z
author: caorushizi
tags:
  - Vue.js
postSlug: 41132096-4901-45d1-a453-6119931a083e
description: >-
  一、思考 我们都听过知其然知其所以然这句话 那么不知道大家是否思考过new Vue()这个过程中究竟做了些什么？
  过程中是如何完成数据的绑定，又是如何将数据渲染到视图的等等 一、分析 首先找到vue的构造函数
  源码位置：src\core\instance\index.js function Vue (options) { if
  (process.env.NODE_ENV !== 'producti
difficulty: 2
questionNumber: 227
source: https://fe.ecool.fun/topic/41132096-4901-45d1-a453-6119931a083e
---
