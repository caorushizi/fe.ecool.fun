...
tags:
  - javascript
postSlug: c3bc3a5b499179decf07195df49461ac
description: >-
  浏览器是多进程的--------它主要包括以下进程：*Browser进程：浏览器的主进程，唯一，负责创建和销毁其它进程、网络资源的下载与管理、浏览器界面的展示、前进后退等。*GPU进程：用于3D绘制等
difficulty: 2
questionNumber: 49
source: >-
  https://fe.ecool.fun/topic-answer/fe257d38-7fa5-4062-bdc5-e11525b984a4?orderBy=updateTime&order=desc&tagId=10
---
