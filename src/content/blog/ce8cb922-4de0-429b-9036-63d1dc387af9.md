...
pubDatetime: 2021-07-07T00:11:03.000Z
author: caorushizi
tags:
  - 工程化
postSlug: ce8cb922-4de0-429b-9036-63d1dc387af9
description: >-
  webpack的热更新又称热替换（Hot Module Replacement），缩写为HMR。
  这个机制可以做到不用刷新浏览器而将新变更的模块替换掉旧的模块。 首先要知道server端和client端都做了处理工作 第一步，在 webpack 的
  watch 模式下，文件系统中某一个文件发生修改，webpack 监听到文件变化，根据配置文件对模块重新编译打包，并将打包后的代码通过简单的 Java
difficulty: 2
questionNumber: 383
source: https://fe.ecool.fun/topic/ce8cb922-4de0-429b-9036-63d1dc387af9
---
