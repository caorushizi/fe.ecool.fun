---
title: 说说ReactJsx转换成真实DOM过程？
pubDatetime: 2023-03-25T16:00:00.000Z
author: caorushizi
tags:
  - react
postSlug: d86c1540719a6f8dc2ff534f35f68d16
description: >-
  一、是什么-----`react`通过将组件编写的`JSX`映射到屏幕，以及组件中的状态发生了变化之后`React`会将这些「变化」更新到屏幕上在前面文章了解中，`JSX`通过`babel`最终转化成
difficulty: 2
questionNumber: 16
source: >-
  https://fe.ecool.fun/topic-answer/6eec7f26-3bdc-4015-86fc-a75d495311a6?orderBy=updateTime&order=desc&tagId=13
---
