...
tags:
  - html
postSlug: a346c3788c9b5cf3c90580a38b9ec5ca
description: >-
  整个渲染过程其实就是将URL对应的各种资源，通过浏览器渲染引擎的解析，输出可视化的图像。基本概念----*HTML解释器：解释HTML语言的解释器，本质是将HTML文本解释成DOM树（文档对象模型）。
difficulty: 3
questionNumber: 50
source: >-
  https://fe.ecool.fun/topic-answer/61b47ff6-9c4d-4fa2-b126-dc5ffff3e7c6?orderBy=updateTime&order=desc&tagId=12
---
