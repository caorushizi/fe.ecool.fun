...
tags:
  - vue
postSlug: ad6b7b701d80cfa8117b2f63761a7139
description: >-
  一、组件间通信的概念----------开始之前，我们把**组件间通信**这个词进行拆分*组件*通信都知道组件是`vue`最强大的功能之一，`vue`中每一个`.vue`我们都可以视之为一个组件。通信
difficulty: 2
questionNumber: 2
source: >-
  https://fe.ecool.fun/topic-answer/a88670ef-a898-4676-a272-cabf8bdfade7?orderBy=updateTime&order=desc&tagId=14
---
