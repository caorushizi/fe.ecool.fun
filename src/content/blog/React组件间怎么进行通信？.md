---
title: React组件间怎么进行通信？
pubDatetime: 2021-10-22T16:00:00.000Z
author: caorushizi
tags:
  - react
postSlug: 856c856f51a107845f970a5d7216e6c9
description: >-
  一、是什么-----我们将组件间通信可以拆分为两个词：*组件*通信`React`的组件灵活多样，按照不同的方式可以分成很多类型的组件而通信指的是发送者通过某种媒体以某种格式来传递信息到收信者以达到某个
difficulty: 3
questionNumber: 65
source: >-
  https://fe.ecool.fun/topic-answer/08ec624c-9c3d-4f11-ba4f-09e0986c9838?orderBy=updateTime&order=desc&tagId=13
---
