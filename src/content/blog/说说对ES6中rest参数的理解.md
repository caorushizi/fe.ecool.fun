---
title: 说说对ES6中rest参数的理解
pubDatetime: 2022-04-10T16:00:00.000Z
author: caorushizi
tags:
  - es6
postSlug: 2069799beb01a15dad5ebfb32236430a
description: >-
  ES6引入rest参数（形式为`...变量名`），用于获取函数的多余参数，这样就不需要使用`arguments`对象了。rest参数搭配的变量是一个数组，该变量将多余的参数放入数组中。```jsfun
difficulty: 2
questionNumber: 13
source: >-
