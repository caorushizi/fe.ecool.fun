...
tags:
  - typescript
postSlug: acc37d1360c4d202a4bd04f30830e6ed
description: >-
  在TypeScript中，方法重载（MethodOverloading）是一种允许函数在不同参数数量或参数类型下具有不同的返回类型或行为的特性。这允许您以一种更灵活的方式定义函数，并根据传入的参数类型
difficulty: 2
questionNumber: 2
source: >-
  https://fe.ecool.fun/topic-answer/92dd5aef-8f57-4e85-a877-30f46de54fc9?orderBy=updateTime&order=desc&tagId=19
---
