---
title: Axios的原理是什么？
pubDatetime: 2024-01-25T15:38:30.000Z
author: caorushizi
tags:
  - JavaScript
postSlug: 605ec5f7-3768-4aa4-8cdc-3b5bd90bebc3
description: >-
  一、axios的使用 关于axios的基本使用，上篇文章已经有所涉及，这里再稍微回顾下： 发送请求 import axios from 'axios';
  axios(config) // 直接传入配置 axios(url[, config]) // 传入url和配置 axios[method](url[,
  option]) // 直接调用请求方式方法，传入url和配置 axios[method](
difficulty: 3
questionNumber: 247
source: https://fe.ecool.fun/topic/605ec5f7-3768-4aa4-8cdc-3b5bd90bebc3
---
