...
tags:
  - 算法
postSlug: 76c2856b07f517d29742384480501620
description: >-
  什么是尾调用？-------尾调用的概念非常简单，一句话就能说清楚，就是指某个函数的最后一步是调用另一个函数。```javascriptfunctionf(x){returng(x);}```上面代码
difficulty: 2
questionNumber: 4
source: >-
  https://fe.ecool.fun/topic-answer/246fb719-7819-481e-943d-480a219e29b4?orderBy=updateTime&order=desc&tagId=15
---
