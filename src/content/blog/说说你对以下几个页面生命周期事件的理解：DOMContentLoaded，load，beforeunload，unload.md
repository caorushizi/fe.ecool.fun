...
tags:
  - html
postSlug: a529aea0f3502370e8fc1eeecd64384e
description: >-
  HTML页面的生命周期包含三个重要事件：*DOMContentLoaded——浏览器已完全加载HTML，并构建了DOM树，但像<img>和样式表之类的外部资源可能尚未加载完成。*load——浏览器不仅
difficulty: 1.5
questionNumber: 33
source: >-
  https://fe.ecool.fun/topic-answer/43dad801-6c42-4638-9006-2c51a7cf0c91?orderBy=updateTime&order=desc&tagId=12
---
