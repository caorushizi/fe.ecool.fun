---
title: 写一个repeat方法，实现字符串的复制拼接
pubDatetime: 2022-02-27T16:00:00.000Z
author: caorushizi
tags:
  - 编程题
postSlug: 8aee64d3113176a66d2096aab8bc9fcd
description: >-
  实现的方法有很多，以下介绍几种。方法一---空数组join```jsfunctionrepeat(target,n){return(newArray(n+1)).join(target);}```方法
difficulty: 1
questionNumber: 45
source: >-
