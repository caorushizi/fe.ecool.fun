...
pubDatetime: 2024-01-25T19:22:37.000Z
author: caorushizi
tags:
  - 工具
...
description: >-
  ...
  添加到暂存区的修改（staged changes） Git跟踪的但并未添加到暂存区的修改（unstaged changes） 但以下
difficulty: 1
questionNumber: 644
source: https://fe.ecool.fun/topic/7aa8fdff-3c1c-423c-8f2d-cd784dfcbac1
---
...
显示保存进度的列表。也就意味着，`git stash`命令可以多次执行，当多次使用`git stash`命令后，栈里会充满未提交的代码，如下：
 ...
 ![](https://static.ecool.fun//article/c5f22a2b-6b20-41e8-8da4-5af56d546d0f.png)
...
通过使用`git stash show stash@{1}`查看指定的`stash`和当前目录差异
 ...
 ![](https://static.ecool.fun//article/81633809-bc53-485e-bd33-a1473c843ff1.png)
