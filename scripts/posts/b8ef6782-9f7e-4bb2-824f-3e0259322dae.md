...
pubDatetime: 2024-01-25T19:06:44.000Z
author: caorushizi
tags:
  - 工程化
postSlug: b8ef6782-9f7e-4bb2-824f-3e0259322dae
description: >-
  一、是什么 Plugin（Plug-in）是一种计算机应用程序，它和主应用程序互相交互，以提供特定的功能
  是一种遵循一定规范的应用程序接口编写出来的程序，只能运行在程序规定的系统下，因为其需要调用原纯净系统提供的函数库或者数据
  webpack中的plugin也是如此，plugin赋予其各种灵活的功能，例如打包优化、资源管理、环境变量注入等，它们会运行在 webpack
  的不同阶段（钩子 / 生命周
difficulty: 1.5
questionNumber: 388
source: https://fe.ecool.fun/topic/b8ef6782-9f7e-4bb2-824f-3e0259322dae
---
